...
|--------------------|---------------|-----------------|
| 2024.6.18          | v1.7.0 (beta) | [Download](https://github.com/Brybry16/BetterOtherRoles/releases/download/v1.7.0-beta2/BetterOtherRoles.v1.7.0.zip)
...
- Fixed an issue where some users was disconnected in lobby 
- Added a new impostor role: Sticky Bomber
  
**Version 1.3.x**
- Added a new impostor role: Undertaker
</details>
