    ...
    public static class Helpers
    {
        ...
        public static AudioClip loadAudioClipFromResources(string path, string clipName = "UNNAMED_TOR_AUDIO_CLIP") {
            ...
            try {
                ...
                BetterOtherRolesPlugin.Logger.LogInfo("Creating audio clip: " + clipName);
        ...
        public static bool hidePlayerName(PlayerControl source, PlayerControl target) {
            if (Camouflager.camouflageTimer > 0f || (Helpers.MushroomSabotageActive() && !source.Data.IsDead && !source.Data.Role.IsImpostor)) return true; // No names are visible
        ...
        public static void toggleZoom(bool reset=false) {
            ...
            if (tzGO != null)
            {
                ...
                rend.sprite = zoomOutStatus ? Helpers.loadSpriteFromResources("BetterOtherRoles.Resources.Plus_Button.png", 100f) : Helpers.loadSpriteFromResources("BetterOtherRoles.Resources.Minus_Button.png", 100f);
                rendActive.sprite = zoomOutStatus ? Helpers.loadSpriteFromResources("BetterOtherRoles.Resources.Plus_ButtonActive.png", 100f) : Helpers.loadSpriteFromResources("BetterOtherRoles.Resources.Minus_ButtonActive.png", 100f);
