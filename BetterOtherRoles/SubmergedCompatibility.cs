...
namespace BetterOtherRoles
{
    public static class SubmergedCompatibility
    {
        ...
        public static bool TryLoadSubmerged()
        {
            try
            {
                BetterOtherRolesPlugin.Logger.LogMessage("Trying to load Submerged...");
        ...
        public static void Initialize()
        {
            ...
            object OxygenMaskCustomTaskType = RetrieveOxigenMaskTaskTypeField.GetValue(null);
        ...
        public static void RepairOxygen() {
            ...
            try {
                ...
                BetterOtherRolesPlugin.Logger.LogMessage("null reference in engineer oxygen fix");
            }
