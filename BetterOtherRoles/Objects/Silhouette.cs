...
public class Silhouette
{
    ...
    public static Sprite getSilhouetteSprite()
    {
        ...
        SilhouetteSprite = Helpers.loadSpriteFromResources("BetterOtherRoles.Resources.Silhouette.png", 225f);
    ...
    public Silhouette(Vector3 p, float duration = 1f, bool visibleForEveryOne = true)
    {
        ...
        bool visible = visibleForEveryOne || PlayerControl.LocalPlayer == Yoyo.yoyo ||
    ...
    public static void UpdateAll()
    {
        foreach (Silhouette current in new List<Silhouette>(silhouettes))
        {
            ...
            bool visible = current.visibleForEveryOne || PlayerControl.LocalPlayer == Yoyo.yoyo ||
                           PlayerControl.LocalPlayer.Data.IsDead;
