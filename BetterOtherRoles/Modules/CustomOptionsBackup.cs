...
//
//     public event UpdateEvent OnChange;
//
//     // Option creation
//
//     public CustomOption(int id, CustomOptionType type, string name, System.Object[] selections,
//         System.Object defaultValue, CustomOption parent, bool isHeader, string suffix, ValueType valueType, Action onChange = null, string heading = "")
//     {
//         this.id = id;
...
//         CustomOption parent = null, bool isHeader = false, string suffix = "", Action onChange = null, string heading = "")
//     {
//         return new CustomOption(id, type, name, selections, "", parent, isHeader, suffix, ValueType.String, onChange, heading);
//     }
//
//     public static CustomOption Create(int id, CustomOptionType type, string name, float defaultValue, float min,
//         float max, float step, CustomOption parent = null, bool isHeader = false, string suffix = "", Action onChange = null, string heading = "")
//     {
//         List<object> selections = new();
//         for (float s = min; s <= max; s += step)
//             selections.Add(s);
//         return new CustomOption(id, type, name, selections.ToArray(), defaultValue, parent, isHeader, suffix,
//             ValueType.Float, onChange, heading);
//     }
//
//     public static CustomOption Create(int id, CustomOptionType type, string name, bool defaultValue,
//         CustomOption parent = null, bool isHeader = false, string suffix = "", Action onChange = null, string heading = "")
//     {
//         return new CustomOption(id, type, name, new string[] { "Off", "On" }, defaultValue ? "On" : "Off", parent,
//             isHeader, suffix, ValueType.Boolean, onChange, heading);
//     }
//
//     // Static behaviour
//
...
//
//             option.entry =
//                 BetterOtherRolesPlugin.Instance.Config.Bind($"Preset{preset}", option.id.ToString(),
...
//             (byte)CustomRPC.ShareOptions, SendOption.Reliable, -1);
//         writer.Write((byte)1);
...
//         {
//             DestroyableSingleton<HudManager>.Instance.Notifier.AddSettingsChangeMessage((StringNames)(this.id + 6000),
//                 selections[newSelection].ToString(), false);
//             try
//             {
//                 if (GameStartManager.Instance != null && GameStartManager.Instance.LobbyInfoPane != null &&
//                     GameStartManager.Instance.LobbyInfoPane.LobbyViewSettingsPane != null && GameStartManager.Instance
//                         .LobbyInfoPane.LobbyViewSettingsPane.gameObject.activeSelf)
//                 {
//                     GameOptionsMenuChangeTabPatch.LobbyViewSettingsPaneChangeTabPatch.Postfix(GameStartManager.Instance.LobbyInfoPane.LobbyViewSettingsPane, GameStartManager.Instance.LobbyInfoPane.LobbyViewSettingsPane.currentTab);
//                 }
//             } catch { }
//         }
...
//             {
//                 toggleOption.oldValue = toggleOption.CheckMark.enabled = getBool();
//             }
//
//
//             if (AmongUsClient.Instance && AmongUsClient.Instance.AmHost && CachedPlayer.LocalPlayer.PlayerControl)
//             {
...
//                 option.entry = BetterOtherRolesPlugin.Instance.Config.Bind($"Preset{preset}", option.id.ToString(),
//                     option.defaultSelection);
...
//             $"{BetterOtherRolesPlugin.VersionString}!{Convert.ToBase64String(serializeOptions())}!{vanillaSettings.Value}";
//     }
//
//     public static int pasteFromClipboard()
//     {
//         string allSettings = GUIUtility.systemCopyBuffer;
//         int borOptionsFine = 0;
...
//
//             borOptionsFine = deserializeOptions(Convert.FromBase64String(torSettings));
//             ShareOptionSelections();
//             if (BetterOtherRolesPlugin.Version > versionInfo && versionInfo < Version.Parse("1.7.0"))
//             {
//                 vanillaOptionsFine = false;
//                 FastDestroyableSingleton<HudManager>.Instance.Chat.AddChat(PlayerControl.LocalPlayer, "Host Info: Pasting vanilla settings failed, BOR Options applied!");
//             }
//         }
//         catch (Exception e)
//         {
...
//         }
//
//         return Convert.ToInt32(vanillaOptionsFine) + borOptionsFine;
//     }
// }
//
...
//     public static class LobbyViewSettingsPatch
//     {
...
//             var borSettingsButton = GameObject.Find(buttonName);
//             if (borSettingsButton == null)
//             {
//                 borSettingsButton = GameObject.Instantiate(buttonTemplate, buttonTemplate.transform.parent);
//                 borSettingsButton.transform.localPosition += Vector3.right * 1.75f * (targetMenu - 2);
//                 borSettingsButton.name = buttonName;
//                 __instance.StartCoroutine(Effects.Lerp(2f,
//                     new Action<float>(_ =>
//                     {
//                         borSettingsButton.transform.FindChild("FontPlacer").GetComponentInChildren<TextMeshPro>()
//                             .text = buttonText;
//                     })));
//
//                 var borSettingsPassiveButton = borSettingsButton.GetComponent<PassiveButton>();
//                 borSettingsPassiveButton.OnClick.RemoveAllListeners();
//                 borSettingsPassiveButton.OnClick.AddListener((System.Action)(() =>
//                 {
//                     __instance.ChangeTab((StringNames)targetMenu);
//                 }));
//                 borSettingsPassiveButton.OnMouseOut.RemoveAllListeners();
//                 borSettingsPassiveButton.OnMouseOver.RemoveAllListeners();
//                 borSettingsPassiveButton.SelectButton(false);
//                 currentButtons.Add(borSettingsPassiveButton);
...
//         {
//             var rolesTab = GameObject.Find("RolesTab");
//             if (rolesTab)
...
//                     x.type == optionType ||
//                     x.type == CustomOptionType.Guesser && optionType == CustomOptionType.General)
//                 .ToList();
//
...
//                             relevantOptions.Insert(relevantOptions.IndexOf(CustomOptionHolder.jackalSpawnRate) + 1,
//                                 option);
//                         else if (option.id == 358) // Prosecutor
//                             relevantOptions.Insert(relevantOptions.IndexOf(CustomOptionHolder.lawyerSpawnRate) + 1,
//                                 option);
//                     }
//                 }
//             }
...
//             {
//                 relevantOptions = relevantOptions.Where(x =>
//                     !(new List<int> { 310, 311, 312, 313, 314, 315, 316, 317, 318 }).Contains(x.id)).ToList();
//             }
//
//             for (int j = 0; j < __instance.settingsInfo.Count; j++)
//             {
//                 UnityEngine.Object.Destroy(__instance.settingsInfo[j].gameObject);
//             }
//
...
//                         UnityEngine.Object.Instantiate<CategoryHeaderMasked>(__instance.categoryHeaderOrigin);
...
//                 }
//
//                 ViewSettingsInfoPanel viewSettingsInfoPanel =
//                     UnityEngine.Object.Instantiate<ViewSettingsInfoPanel>(__instance.infoPanelOrigin);
...
//                 if (option.isHeader && (int)optionType != 99 && option.heading == "" &&
//                     option.type is CustomOptionType.Neutral or CustomOptionType.Crewmate or CustomOptionType.Impostor
//                         or CustomOptionType.Modifier)
//                 {
...
//             __instance.scrollBar.CalculateAndSetYBounds((float)(__instance.settingsInfo.Count + singles * 2 + headers),
//                 2f, 6f, actual_spacing);
//         }
//
...
//
//                 // create TOR settings
//                 createCustomButton(__instance, next++, "TORSettings", "BOR Settings", CustomOptionType.General);
//                 // create TOR settings
...
//                     CustomOptionType.HideNSeekMain);
...
//                 Helpers.loadSpriteFromResources("BetterOtherRoles.Resources.CopyActive.png", 100f);
...
//                 Helpers.loadSpriteFromResources("BetterOtherRoles.Resources.PasteActive.png", 100f);
...
//                 {
//                     CategoryHeaderMasked categoryHeaderMasked =
//                         UnityEngine.Object.Instantiate<CategoryHeaderMasked>(menu.categoryHeaderOrigin, Vector3.zero,
...
//                 }
//
//                 OptionBehaviour optionBehaviour = UnityEngine.Object.Instantiate<StringOption>(menu.stringOptionOrigin,
//                     Vector3.zero, Quaternion.identity, menu.settingsContainer);
...
//                 if (option.isHeader && option.heading == "" && (option.type == CustomOptionType.Neutral ||
...
//                     new Action<float>(p =>
//                     {
//                         torSettingsButton.transform.FindChild("FontPlacer").GetComponentInChildren<TextMeshPro>()
//                             .text = buttonText;
//                     })));
...
//
//                 // create TOR settings
//                 createCustomButton(__instance, next++, "TORSettings", "BOR Settings");
...
//             __instance.ValueText.text = option.DisplayValue;
//
//             return false;
//         }
//     }
...
//                 {
//                     string line = $"{option.name}: {option.DisplayValue}";
...
//                 {
//                     if (option.id == 103) //Deputy
//                         sb.AppendLine($"- {Helpers.cs(Deputy.color, "Deputy")}: {option.DisplayValue}");
//                     else if (option.id == 224) //Sidekick
//                         sb.AppendLine($"- {Helpers.cs(Sidekick.color, "Sidekick")}: {option.DisplayValue}");
//                     else if (option.id == 358) //Prosecutor
//                         sb.AppendLine($"- {Helpers.cs(Lawyer.color, "Prosecutor")}: {option.DisplayValue}");
//                 }
//             }
//
...
//                     option.type != CustomOptionType.HideNSeekMain &&
...
//                     sb.AppendLine(Helpers.cs(c, $"{option.name}: {option.DisplayValue}"));
//                 }
//                 else
//                 {
...
//             }
//
//             if (BetterOtherRolesPlugin.optionsPage >= GameOptionsDataPatch.maxPage)
//                 BetterOtherRolesPlugin.optionsPage = 0;
//         }
//     }
//
...
//                 SpriteRenderer renderer = toggleSettingsButtonObject.transform.Find("Inactive")
...
//                 renderer.sprite =
//                     Helpers.loadSpriteFromResources("BetterOtherRoles.Resources.Settings_Button.png", 100f);
//                 rendererActive.sprite =
//                     Helpers.loadSpriteFromResources("BetterOtherRoles.Resources.Settings_ButtonActive.png", 100f);
...
//                 toggleSettingsButton.OnClick.AddListener((Action)(() => UIManager.CustomOptionsPanel?.Toggle()));
//             }
//
...
//             {
//                 // add a special button for settings viewing:
//                 toggleZoomButtonObject = GameObject.Instantiate(__instance.MapButton.gameObject,
...
//                 SpriteRenderer tZrenderer =
//                     toggleZoomButtonObject.transform.Find("Inactive").GetComponent<SpriteRenderer>();
//                 SpriteRenderer tZArenderer =
//                     toggleZoomButtonObject.transform.Find("Active").GetComponent<SpriteRenderer>();
...
//                 tZArenderer.sprite =
//                     Helpers.loadSpriteFromResources("TheOtherRoles.Resources.Minus_ButtonActive.png", 100);
...
//             bool zoomButtonActive = !(CachedPlayer.LocalPlayer.PlayerControl == null ||
